...
from a2_misc_data import TRITON_REVIEW

EXPECTED = {
    '/r2b/triton_container':     container_expected(),
...
SPEC = {
    'title': 'TRITON-NODE-A2',
    'name': 'isaac_ros_triton',
    'image': 'fish-r2b-triton:latest',
    'launch_script': 'isaac_ros_benchmark/benchmarks/isaac_ros_triton_benchmark/scripts/isaac_ros_triton_ps_node.py',
    'container_name': 'triton_container',
    'components_desc': 'DataLoader + Playback(1 tensor) + Monitor + 5 image preprocessing + TritonNode',
    'extra_fields': {},
    'expected': EXPECTED,
    'per_node_reviews': {
