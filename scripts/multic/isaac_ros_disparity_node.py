...
def launch_setup(container_prefix, container_sigterm_timeout):
    ...
    # FISH multi-container variant: each composable in its own container so
    # pub→sub traffic is cross-process → rcl_publish path → our patches catch it.
    def _wrap(name, node):
    ...
    return [
        _wrap('cnt_data_loader',  data_loader_node),
        _wrap('cnt_prep_left',    prep_left_resize_node),
        _wrap('cnt_prep_right',   prep_right_resize_node),
        _wrap('cnt_playback',     playback_node),
        _wrap('cnt_monitor',      monitor_node),
        _wrap('cnt_disparity',    disparity_node),
    ]
