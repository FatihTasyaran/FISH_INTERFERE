...
EXPECTED = {
    '/r2b/unet_container':       container_expected(),
    ...
    '/r2b/UNetDecoderNode':      nitros_node(1, 2, runtime_extra_E=1, runtime_extra_F=1),  # 1 in, 2 outs (raw + colored)
}

SPEC = {
    'title': 'UNET-NODE-A2',
    'name': 'isaac_ros_unet',
    'image': 'fish-r2b-unet:latest',
    'launch_script': 'isaac_ros_benchmark/benchmarks/isaac_ros_unet_benchmark/scripts/isaac_ros_unet_graph.py',
    'container_name': 'unet_container',
    'components_desc': 'DataLoader + Playback(2 NITROS) + Monitor + 5 image preprocessing nodes (resize, image_format_converter, image_to_tensor, normalize, reshape) + TensorRTNode + UNetDecoderNode',
    'extra_fields': {},
    'expected': EXPECTED,
    'per_node_reviews': {
        ...
        'node_UNetDecoderNode':                 UNET_DECODER_REVIEW,
    },
}
