# Agent Journal — `isaac_ros_bi3d_freespace`
...
## Identity
- **Benchmark:** `isaac_ros_bi3d_freespace`
- **Image tag goal:** `fish-r2b-bi3d_freespace:latest`
- **Workload repos (from inventory):** ['isaac_ros_depth_segmentation', 'isaac_ros_freespace_segmentation']
- **Smoke-test script:** `isaac_ros_bi3d_fs_node`
...
- **Final image:** `fish-r2b-bi3d_freespace:latest`
