# Agent Journal — `isaac_ros_image_proc`
...
## Identity
- **Benchmark:** `isaac_ros_image_proc`
- **Image tag goal:** `fish-r2b-image_proc:latest`
- **Workload repos (from inventory):** []
- **Smoke-test script:** `isaac_ros_rectify_node`
...
- **Final image:** `fish-r2b-image_proc:latest`
