# Agent Journal — `isaac_ros_tensor_rt`
...
## Identity
- **Benchmark:** `isaac_ros_tensor_rt`
- **Image tag goal:** `fish-r2b-tensor_rt:latest`
- **Workload repos (from inventory):** ['isaac_ros_dnn_inference', 'isaac_ros_pose_estimation']
- **Smoke-test script:** `isaac_ros_tensor_rt_dope_node`
...
- **Final image:** `fish-r2b-tensor_rt:latest`
