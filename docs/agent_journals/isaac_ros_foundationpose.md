# Agent Journal — `isaac_ros_foundationpose`
...
## Identity
- **Benchmark:** `isaac_ros_foundationpose`
- **Image tag goal:** `fish-r2b-foundationpose:latest`
- **Workload repos (from inventory):** ['isaac_ros_pose_estimation', 'isaac_ros_dnn_stereo_depth', 'isaac_ros_object_detection']
- **Smoke-test script:** `isaac_ros_foundationpose_node`
...
- **Final image:** `fish-r2b-foundationpose:latest`
