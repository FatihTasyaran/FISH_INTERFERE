# Agent Journal — `isaac_ros_h264_encoder`
...
## Identity
- **Benchmark:** `isaac_ros_h264_encoder`
- **Image tag goal:** `fish-r2b-h264_encoder:latest`
- **Workload repos (from inventory):** ['isaac_ros_compression']
- **Smoke-test script:** `isaac_ros_h264_encoder_iframe_node`
...
- **Final image:** `fish-r2b-h264_encoder:latest`
