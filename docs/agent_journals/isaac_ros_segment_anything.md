# Agent Journal — `isaac_ros_segment_anything`
...
## Identity
- **Benchmark:** `isaac_ros_segment_anything`
- **Image tag goal:** `fish-r2b-segment_anything:latest`
- **Workload repos (from inventory):** ['isaac_ros_image_segmentation', 'isaac_ros_dnn_inference']
- **Smoke-test script:** `isaac_ros_segment_anything_graph`
...
- **Final image:** `fish-r2b-segment_anything:latest`
