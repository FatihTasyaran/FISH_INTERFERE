...
## Identity
- **Benchmark:** `isaac_ros_unet`
- **Image tag goal:** `fish-r2b-unet:latest`
- **Workload repos (from inventory):** ['isaac_ros_image_segmentation', 'isaac_ros_dnn_inference']
- **Smoke-test script:** `isaac_ros_unet_graph`
...
- **Final image:** `fish-r2b-unet:latest`
