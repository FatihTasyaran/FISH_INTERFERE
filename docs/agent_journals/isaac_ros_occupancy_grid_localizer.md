# Agent Journal — `isaac_ros_occupancy_grid_localizer`
...
## Identity
- **Benchmark:** `isaac_ros_occupancy_grid_localizer`
- **Image tag goal:** `fish-r2b-occupancy_grid_localizer:latest`
- **Workload repos (from inventory):** ['isaac_ros_mapping_and_localization']
- **Smoke-test script:** `isaac_ros_grid_localizer_node`
...
- **Final image:** `fish-r2b-occupancy_grid_localizer:latest`
