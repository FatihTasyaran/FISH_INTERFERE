# Agent Journal — `isaac_ros_visual_slam`
...
## Identity
- **Benchmark:** `isaac_ros_visual_slam`
- **Image tag goal:** `fish-r2b-visual_slam:latest`
- **Workload repos (from inventory):** ['isaac_ros_visual_slam']
- **Smoke-test script:** `isaac_ros_visual_slam_node`
...
- **Final image:** `fish-r2b-visual_slam:latest`
