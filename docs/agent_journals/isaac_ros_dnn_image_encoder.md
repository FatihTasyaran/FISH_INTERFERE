# Agent Journal — `isaac_ros_dnn_image_encoder`
...
## Identity
- **Benchmark:** `isaac_ros_dnn_image_encoder`
- **Image tag goal:** `fish-r2b-dnn_image_encoder:latest`
- **Workload repos (from inventory):** ['isaac_ros_dnn_inference']
- **Smoke-test script:** `isaac_ros_dnn_image_encoder_node`
...
- **Final image:** `fish-r2b-dnn_image_encoder:latest`
