...
## Identity
- **Benchmark:** `isaac_ros_dope`
- **Image tag goal:** `fish-r2b-dope:latest`
- **Workload repos (from inventory):** ['isaac_ros_pose_estimation', 'isaac_ros_dnn_inference']
- **Smoke-test script:** `isaac_ros_dope_graph`
...
- **Final image:** `fish-r2b-dope:latest`
