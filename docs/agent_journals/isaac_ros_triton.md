# Agent Journal — `isaac_ros_triton`
...
## Identity
- **Benchmark:** `isaac_ros_triton`
- **Image tag goal:** `fish-r2b-triton:latest`
- **Workload repos (from inventory):** ['isaac_ros_dnn_inference', 'isaac_ros_pose_estimation']
- **Smoke-test script:** `isaac_ros_triton_dope_node`
...
- **Final image:** `fish-r2b-triton:latest`
