# Agent Journal — `isaac_ros_pynitros`
...
## Identity
- **Benchmark:** `isaac_ros_pynitros`
- **Image tag goal:** `fish-r2b-pynitros:latest`
- **Workload repos (from inventory):** ['isaac_ros_dnn_inference', 'isaac_ros_image_segmentation']
- **Smoke-test script:** `isaac_ros_pynitros_unet_graph`
...
- **Final image:** `fish-r2b-pynitros:latest`
