# Agent Journal — `isaac_ros_segformer`
...
## Identity
- **Benchmark:** `isaac_ros_segformer`
- **Image tag goal:** `fish-r2b-segformer:latest`
- **Workload repos (from inventory):** ['isaac_ros_image_segmentation', 'isaac_ros_dnn_inference']
- **Smoke-test script:** `isaac_ros_segformer_graph`
...
- **Final image:** `fish-r2b-segformer:latest`
