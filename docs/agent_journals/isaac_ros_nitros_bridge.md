# Agent Journal — `isaac_ros_nitros_bridge`
...
## Identity
- **Benchmark:** `isaac_ros_nitros_bridge`
- **Image tag goal:** `fish-r2b-nitros_bridge:latest`
- **Workload repos (from inventory):** []
- **Smoke-test script:** `isaac_ros_nitros_bridge`
...
- **Final image:** `fish-r2b-nitros_bridge:latest`
