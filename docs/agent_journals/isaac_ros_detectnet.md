# Agent Journal — `isaac_ros_detectnet`
...
## Identity
- **Benchmark:** `isaac_ros_detectnet`
- **Image tag goal:** `fish-r2b-detectnet:latest`
- **Workload repos (from inventory):** ['isaac_ros_object_detection', 'isaac_ros_dnn_inference']
- **Smoke-test script:** `isaac_ros_detectnet_graph`
...
- **Final image:** `fish-r2b-detectnet:latest`
