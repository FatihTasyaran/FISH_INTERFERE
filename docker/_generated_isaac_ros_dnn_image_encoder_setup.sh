#!/bin/bash
# Auto-generated workload setup for isaac_ros_dnn_image_encoder
set -e
...
colcon build --packages-up-to isaac_ros_dnn_image_encoder_benchmark isaac_ros_benchmark --cmake-args -DCMAKE_POLICY_VERSION_MINIMUM=3.30
