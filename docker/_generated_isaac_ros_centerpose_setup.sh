#!/bin/bash
# Auto-generated workload setup for isaac_ros_centerpose
set -e

bash /tmp/setup_isaac_workspace.sh --gpu --datasets /nonexistent

cd /root/ros_ws/src
git clone --depth 1 --branch release-3.2 https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_pose_estimation.git || true
...
colcon build --packages-up-to isaac_ros_centerpose_benchmark isaac_ros_benchmark --cmake-args -DCMAKE_POLICY_VERSION_MINIMUM=3.30
