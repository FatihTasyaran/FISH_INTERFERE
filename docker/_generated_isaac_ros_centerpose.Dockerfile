...
# Target benchmark: isaac_ros_centerpose   (isaac_ros_pose_estimation isaac_ros_dnn_inference)
FROM fish-base:cuda12.6-humble

COPY scripts/setup_isaac_workspace.sh /tmp/setup_isaac_workspace.sh
COPY docker/_generated_isaac_ros_centerpose_setup.sh /tmp/workload_setup.sh
